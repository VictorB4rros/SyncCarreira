...
\usepackage{amssymb}                    % Símbolos matemáticos (ex: \checkmark)
...
% \usepackage{abntex-ifpi/tikz-uml}	% Desativado: carrega pgflibraryfadings que bloqueia o PDF no Windows

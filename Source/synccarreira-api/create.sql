...
create table tb_turma (fk_id_instituicao bigint, id_turma bigint not null auto_increment, nome_turma varchar(255), primary key (id_turma)) engine=InnoDB;
...
alter table tb_turma add constraint FKpeim02fhluqpl4u5w2pdyorsd foreign key (fk_id_instituicao) references tb_instituicao (id_instituicao);
